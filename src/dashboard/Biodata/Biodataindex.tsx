...
export default function BiodataIndex() {
  const biodata = [
    { label: "Nama Lengkap", value: "Gusti Rizqi Putra Hanif", icon: <User className="w-5 h-5" /> },
    { label: "NIM", value: "24090066", icon: <Hash className="w-5 h-5" /> },
    ...
    { label: "Alamat", value: "Desa Kluwut Kecamatan Bulakamba Kabupaten Brebes", icon: <MapPin className="w-5 h-5" /> },
  ];
        ...
        <div className="lg:w-72 shrink-0">
          <div className="border-4 border-black shadow-[8px_8px_0px_0px_#000] bg-white p-6 flex flex-col items-center gap-4 hover:shadow-[12px_12px_0px_0px_#000] hover:-translate-x-1 hover:-translate-y-1 transition-all duration-200">
            <div className="relative">
              <div className="absolute inset-0 bg-blue-500 border-4 border-black translate-x-2 translate-y-2 z-0" />
              <img
                src="/img/foto profile.jpg"
                alt="Foto Gusti Rizqi"
          ...
          {biodata.map((item, index) => (
            ...
            >
              <div className="flex items-start gap-3">
                <div className="border-2 border-black bg-blue-500 w-12 h-12 flex items-center justify-center shrink-0 shadow-[3px_3px_0px_0px_#000]">
                  {item.icon}
                </div>
                <div>
              ...
              <div className="mt-4 h-1 bg-blue-500 border border-black" />
            </div>
          ))}
        </div>
      </div>
