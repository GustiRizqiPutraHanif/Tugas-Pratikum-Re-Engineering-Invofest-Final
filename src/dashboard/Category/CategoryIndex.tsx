    ...
    <div className="p-6">
      <div className="flex items-center justify-between border-b-4 border-black pb-4 mb-6">
        ...
        <Link
          ...
          className="bg-blue-500 text-white font-black uppercase text-sm px-4 py-2 border-2 border-black shadow-[3px_3px_0px_0px_#000] hover:bg-blue-400 hover:shadow-[5px_5px_0px_0px_#000] hover:-translate-x-0.5 hover:-translate-y-0.5 active:translate-x-0.5 active:translate-y-0.5 active:shadow-[2px_2px_0px_0px_#000] transition-all"
        >
          + Add New Category
        </Link>
      </div>
      ...
      {loading && (
        <div className="border-2 border-black px-4 py-3 font-bold bg-blue-100 shadow-[3px_3px_0px_0px_#000]">
          Memuat data...
        </div>
      )}
            ...
            <tbody>
              {categories.length === 0 ? (
                ...
                categories.map((cat, index) => (
                  <tr
                    key={cat.id}
                    className="border-t-2 border-black even:bg-gray-50 hover:bg-blue-50 transition-colors"
                  >
                    ...
                    <td className="px-4 py-3 text-center flex gap-2 justify-center">
                      <Link
                        ...
                        className="bg-blue-500 text-white font-black uppercase text-xs px-3 py-1 border-2 border-black shadow-[2px_2px_0px_0px_#000] hover:bg-blue-400 hover:shadow-[3px_3px_0px_0px_#000] hover:-translate-x-0.5 hover:-translate-y-0.5 transition-all"
                      >
                        Edit
                      </Link>
                      <button
